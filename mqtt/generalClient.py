...
'''
    mqtt client: receive mqtt messages and put them to Celery
...
from celeryTasks.tasks import messageHandler
...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.info("Cannot connect to MQTT broker at %s:%d: %s" % (mqttHost, int(mqttPort), str(e)))
        sys.exit(2)
    try:
